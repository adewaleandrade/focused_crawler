...
class Kohana_Inflector {
	...
	public static $ptUncountable = array(
		'atlas',
		'lapis',
		'onibus',
		'pires',
	...
	public static $ptIrregular = array(
		'abdomen' => 'abdomens',
		'alemao' => 'alemaes',
		'artesa' => 'artesaos',
		'as' => 'ases',
	...
	public static function uncountable($str)
	{
		...
		{
			// Cache uncountables
			Inflector::$uncountable = Kohana_Inflector::$ptUncountable;
	...
	public static function singular($str, $count = NULL)
	{
		...
		if (empty(Inflector::$irregular))
		{
			...
			Inflector::$irregular = $this->ptIrregular;
		}
